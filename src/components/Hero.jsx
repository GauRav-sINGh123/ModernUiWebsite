...
function Hero() {
  return (
    <div className='flex flex-col items-center mt-3 lg:mt-15'>
        <h1 className='text-4xl  sm:text-6xl  lg:text-7xl leading-normal  text-center tracking-wide   '>"Explore the cutting-edge <span className=' leading-normal'>features</span> 
